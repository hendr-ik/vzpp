...
.attr("height", function(d) { return data_set_066.bar_height - yScale_066(0); }) // always equal to 0
.attr("y", function(d) { return yScale_066(0); })
gfx_layer_3_066.selectAll("rect")
.transition()
.duration(400)
.attr("y", function(d) { return yScale_066(d.Value); })
.attr("height", function(d) { return data_set_066.bar_height - yScale_066(d.Value); })
