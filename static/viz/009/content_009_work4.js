...
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_rect").attr("width", 0);
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_value").attr("opacity", 0);
d3.select(".gfx_diagram_3").attr("opacity", 0);
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_rect").attr("width", 0);
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_value").attr("opacity", 0);
// switch on ------------------------------------------------
d3.select(".gfx_diagram_1").attr("opacity", 1);
...
// switch out -----------------------------------------------
d3.selectAll(".gfx_diagram_1").attr("opacity", 0);
d3.selectAll(".gfx_diagram_1 .gfx_bar .gfx_bar_rect").attr("width", 0);
d3.selectAll(".gfx_diagram_1 .gfx_bar .gfx_bar_value").attr("opacity", 0);
// switch on ------------------------------------------------
d3.selectAll(".gfx_diagram_2").attr("opacity", 1);
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_rect")
.transition().duration(300).ease(d3.easePolyOut)
.attr("width", (d) => xScale_2(d.value_2));
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_value")
.transition().delay(100).duration(100).attr("opacity", 1);
})
...
// switch out -----------------------------------------------
d3.selectAll(".gfx_diagram_2").attr("opacity", 0);
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_rect").attr("width", 0);
d3.selectAll(".gfx_diagram_2 .gfx_bar .gfx_bar_value").attr("opacity", 0);
// switch on ------------------------------------------------
d3.selectAll(".gfx_diagram_1").attr("opacity", 1);
d3.selectAll(".gfx_diagram_1 .gfx_bar .gfx_bar_rect")
.transition().duration(300).ease(d3.easePolyOut)
.attr("width", (d) => xScale_1(d.value_1));
d3.selectAll(".gfx_diagram_1 .gfx_bar .gfx_bar_value")
.transition().delay(100).duration(100).attr("opacity", 1);
});
...
d3.selectAll(".gfx_diagram_1 .gfx_bar .gfx_bar_value").attr("opacity", 0);
// switch on ------------------------------------------------
d3.selectAll(".gfx_diagram_3").attr("opacity", 1);
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_rect")
.transition().duration(300).ease(d3.easePolyOut)
.attr("width", (d) => xScale_3(d.value_3));
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_value")
.transition().delay(100).duration(100).attr("opacity", 1);
})
...
// switch out -----------------------------------------------
d3.selectAll(".gfx_diagram_3").attr("opacity", 0);
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_rect").attr("width", 0);
d3.selectAll(".gfx_diagram_3 .gfx_bar .gfx_bar_value").attr("opacity", 0);
// switch on ------------------------------------------------
d3.selectAll(".gfx_diagram_1").attr("opacity", 1);
