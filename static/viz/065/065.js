...
.attr("x", 20)
.attr("y", data_set_065.position_headline + 35)
.attr("height", 2)
.attr("width", 500)
...
return "translate(" + c_065[0]*data_set_065.centroid_extend +"," + c_065[1]*data_set_065.centroid_extend + ")";
})
...
d3.selectAll("input[name='button_A']")
...
.text(data_set_065.text_headline_1)
