...
position_menu: 480,
// ----------------------------------------------------------
text_headline: "Kids Channels on YouTube",
text_subheadline_0: "2018",
text_subheadline_1: "Views",
text_subheadline_2: "Subscript.",
text_subheadline_3: "Uploads",
...
.style("background-color", data_set_063.color_bg);
// set up margin
...
.attr("x", 20)
.attr("y", data_set_063.position_headline + 35)
.attr("height", 2)
.attr("width", 500)
...
.text(data_set_063.text_headline)
.style("fill", data_set_063.color_text_headline);
// create text "subheadline"
var text_subheadline_063 = text_group_063.append("text")
.attr("class", "text_subheadline_top")
.attr("x", 500)
.attr("y", data_set_063.position_headline - 14)
.attr("text-anchor", "end")
.text(data_set_063.text_subheadline_0)
.style("fill", data_set_063.color_text_headline);
// create text "subheadline"
var text_subheadline_063 = text_group_063.append("text")
.attr("class", "text_subheadline")
.attr("x", 500)
.attr("y", data_set_063.position_headline + 4)
.attr("text-anchor", "end")
.text(data_set_063.text_subheadline_1)
.style("fill", data_set_063.color_text_headline);
// create text "source"
