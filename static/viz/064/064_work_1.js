...
// create spacer left
var spacer_left = d3.select("#canvas_064").append("svg")
.attr("height", 540)
.attr("width", 50)
...
var container = d3.select("#canvas_064").append("svg")
...
// ----------------------------------------------------------
// create spacer right
var spacer_right = d3.select("#canvas_064").append("svg")
.attr("height", 540)
.attr("width", 50)
...
g.call(yAxis);
g.select(".domain").remove();
g.selectAll(".tick:not(:first-of-type) line").attr("stroke", data_set.color_layout_axis)
...
.style("fill", data_set.color_layout_axis)
...
.style("fill", "none").style("stroke", data_set.color_bg).style("stroke-width", 9);
// Original graph
gfx_layer_1.append("path")
.datum(data_input_1) // Binds data to the line
.attr("class", "line")
...
d3.selectAll(".gfx_layer_1 .line").style("stroke", data_set.color_graph_b_on);
d3.selectAll(".gfx_layer_1 .dot").attr("opacity", 1);
d3.selectAll(".gfx_layer_1 .label").style("fill", data_set.color_graph_label_b_on);
})
.on("mouseleave", function() {
d3.select(".gfx_layer_5").moveToFront();
d3.selectAll(".gfx_layer_1 .line").style("stroke", data_set.color_graph_b);
d3.selectAll(".gfx_layer_1 .dot").attr("opacity", 0);
d3.selectAll(".gfx_layer_1 .label").style("fill", data_set.color_graph_label_b);
...
.on("mouseenter", function() {
d3.select(this).moveToFront();
d3.selectAll(".gfx_layer_2 .line").style("stroke", data_set.color_graph_b_on);
d3.selectAll(".gfx_layer_2 .dot").attr("opacity", 1);
d3.selectAll(".gfx_layer_2 .label").style("fill", data_set.color_graph_label_b_on);
})
.on("mouseleave", function() {
d3.select(".gfx_layer_5").moveToFront();
d3.selectAll(".gfx_layer_2 .line").style("stroke", data_set.color_graph_b);
d3.selectAll(".gfx_layer_2 .dot").attr("opacity", 0);
d3.selectAll(".gfx_layer_2 .label").style("fill", data_set.color_graph_label_b);
});
...
.on("mouseenter", function() {
d3.select(this).moveToFront();
d3.selectAll(".gfx_layer_3 .line").style("stroke", data_set.color_graph_b_on);
d3.selectAll(".gfx_layer_3 .dot").attr("opacity", 1);
d3.selectAll(".gfx_layer_3 .label").style("fill", data_set.color_graph_label_b_on);
})
.on("mouseleave", function() {
d3.select(".gfx_layer_5").moveToFront();
d3.selectAll(".gfx_layer_3 .line").style("stroke", data_set.color_graph_b);
d3.selectAll(".gfx_layer_3 .dot").attr("opacity", 0);
d3.selectAll(".gfx_layer_3 .label").style("fill", data_set.color_graph_label_b);
});
...
.on("mouseenter", function() {
d3.select(this).moveToFront();
d3.selectAll(".gfx_layer_4 .line").style("stroke", data_set.color_graph_b_on);
d3.selectAll(".gfx_layer_4 .dot").attr("opacity", 1);
d3.selectAll(".gfx_layer_4 .label").style("fill", data_set.color_graph_label_b_on);
})
.on("mouseleave", function() {
d3.select(".gfx_layer_5").moveToFront();
d3.selectAll(".gfx_layer_4 .line").style("stroke", data_set.color_graph_b);
d3.selectAll(".gfx_layer_4 .dot").attr("opacity", 0);
d3.selectAll(".gfx_layer_4 .label").style("fill", data_set.color_graph_label_b);
});
